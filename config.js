System.config({
  ...
  "bundles": {
    ...
    "app-build-0b04aff561": [
      ...
      "npm:aurelia-kendoui-bridge@0.1.0",
      "npm:aurelia-kendoui-bridge@0.1.0/autocomplete/autocomplete",
      "npm:aurelia-kendoui-bridge@0.1.0/button/button",
      "npm:aurelia-kendoui-bridge@0.1.0/chart/chart",
      "npm:aurelia-kendoui-bridge@0.1.0/chart/chart.html!github:systemjs/plugin-text@0.0.4",
      "npm:aurelia-kendoui-bridge@0.1.0/chart/sparkline",
      "npm:aurelia-kendoui-bridge@0.1.0/chart/sparkline.html!github:systemjs/plugin-text@0.0.4",
      "npm:aurelia-kendoui-bridge@0.1.0/chart/stock",
      "npm:aurelia-kendoui-bridge@0.1.0/chart/stock.html!github:systemjs/plugin-text@0.0.4",
      "npm:aurelia-kendoui-bridge@0.1.0/chart/treemap",
      "npm:aurelia-kendoui-bridge@0.1.0/chart/treemap.html!github:systemjs/plugin-text@0.0.4",
      "npm:aurelia-kendoui-bridge@0.1.0/colorpicker/colorpicker",
      "npm:aurelia-kendoui-bridge@0.1.0/combobox/combobox",
      "npm:aurelia-kendoui-bridge@0.1.0/common/constants",
      "npm:aurelia-kendoui-bridge@0.1.0/common/decorators",
      "npm:aurelia-kendoui-bridge@0.1.0/common/events",
      "npm:aurelia-kendoui-bridge@0.1.0/common/options",
      "npm:aurelia-kendoui-bridge@0.1.0/common/template-compiler",
      "npm:aurelia-kendoui-bridge@0.1.0/common/util",
      "npm:aurelia-kendoui-bridge@0.1.0/common/widget-base",
      "npm:aurelia-kendoui-bridge@0.1.0/config-builder",
      "npm:aurelia-kendoui-bridge@0.1.0/datepicker/datepicker",
      "npm:aurelia-kendoui-bridge@0.1.0/dropdownlist/dropdownlist",
      "npm:aurelia-kendoui-bridge@0.1.0/grid/au-col",
      "npm:aurelia-kendoui-bridge@0.1.0/grid/grid",
      "npm:aurelia-kendoui-bridge@0.1.0/grid/grid.html!github:systemjs/plugin-text@0.0.4",
      "npm:aurelia-kendoui-bridge@0.1.0/index",
      "npm:aurelia-kendoui-bridge@0.1.0/menu/menu",
      "npm:aurelia-kendoui-bridge@0.1.0/menu/menu.html!github:systemjs/plugin-text@0.0.4",
      "npm:aurelia-kendoui-bridge@0.1.0/numerictextbox/numerictextbox",
      "npm:aurelia-kendoui-bridge@0.1.0/pdf/pdf",
      "npm:aurelia-kendoui-bridge@0.1.0/progressbar/progressbar",
      "npm:aurelia-kendoui-bridge@0.1.0/scheduler/scheduler",
      "npm:aurelia-kendoui-bridge@0.1.0/slider/slider",
      "npm:aurelia-kendoui-bridge@0.1.0/tabstrip/tabstrip",
      "npm:aurelia-kendoui-bridge@0.1.0/toolbar/toolbar",
      "npm:aurelia-kendoui-bridge@0.1.0/treeview/treeview",
      "npm:aurelia-loader-default@1.0.0-beta.1.0.2",
