...
```
<br>
At this point, take a look at the `map` section inside your `config.js` file.  If you 
see multiple versions of any package like this example where `aurelia-templating` has 
versions 1.2.1 ***and*** 1.2.3, then see below:
```
...
...
```
<br>
When you have a condition like this, you may have problems running your application.
If you do experience any issues and you know you have multiple versions of certain packages
in your `config.js`, run `jspm update`.  Packages should be brought up to date and you'll have 
a better chance of success.  It's not advisable to do this if you're not having any issues.  
...
**Add the mapping needed to access kendo-core plugins**
...
**Add the mapping needed to access kendo-pro plugins**
